...
In order to support loading of multiple wallets in atheneum-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is atheneum.cpp.
...
Changes to atheneum.cpp
----------------------
atheneum.cpp is the entry point into atheneum-qt, and as such, will require some minor modifications to provide hooks for
