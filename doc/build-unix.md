UNIX BUILD NOTES
====================
Some notes on how to build AEM in Unix.
...
memory available when compiling Atheneum. With 512MB of memory or less
...
If you want to build AEM-Qt, make sure that the required packages for Qt development
...
# Configure Atheneum to use our own-built instance of BDB
cd $AEM_ROOT
...
Security
--------
To help make your AEM installation more secure by making certain attacks impossible to
