...
*Setup instructions for a gitian build of AEM using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the AEM
...
- [Building AEM](#building-atheneum)
...
To build AEM (for Linux, OSX and Windows) just follow the steps under 'perform
...
```bash
    ...
    From https://github.com/AtheneumChain/Atheneum
...
[atheneum/gitian.sigs](https://github.com/AtheneumChain/gitian.sigs/) repository, or if that's not possible to create a pull
request.
