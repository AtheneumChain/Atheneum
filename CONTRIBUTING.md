...
confused with overall AEM Network Protocol consensus changes.
...
Patches that change AEM consensus rules are considerably more involved than
...
Where a patch set proposes to change the AEM consensus, it must have been
