...
/** Utility functions used by the Atheneum Qt UI.
 */
namespace GUIUtil
{
...
// Render Atheneum addresses in monospace font
...
// Parse "atheneum:" URI into recipient object, return true on successful parsing
