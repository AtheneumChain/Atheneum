                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Athereum") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Atheneum"), this);
    aboutAction->setStatusTip(tr("Show information about Atheneum"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Atheneum help message to get a list with possible Atheneum command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Atheneum client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Atheneum"); // default title
