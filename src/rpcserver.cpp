    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use atheneumd, or the -server option to atheneum-qt, you must set an rpcpassword in the configuration file:\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"AEM Alert\" admin@foo.com\n"),
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:22001/\n";
}
