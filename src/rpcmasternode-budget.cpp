...
Value mnbudget(const Array& params, bool fHelp)
{
    ...
    if (fHelp ||
        ...
        throw runtime_error(
            ...
            "  vote-many          - Vote on a AEM initiative\n"
            "  vote-alias         - Vote on a AEM initiative\n"
            "  vote               - Vote on a AEM initiative/budget\n"
...
Value preparebudget(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 6)
        throw runtime_error(
            "preparebudget \"proposal-name\" \"url\" payment-count block-start \"aem-address\" monthy-payment\n"
            ...
            "5. \"aem-address\":   (string, required) AEM address to send payments to\n"
...
Value submitbudget(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 7)
        throw runtime_error(
            "submitbudget \"proposal-name\" \"url\" payment-count block-start \"aem-address\" monthy-payment \"fee-tx\"\n"
